...
import { AboutPage, BlogPage, BoardGovernorPage, DashboardPage, DepartmentContactPage, LoginPage, MessagePage, NotFoundPage, SchoolLeadershipPage, SocialMediaPage, SubscribersPage } from "./pages";
