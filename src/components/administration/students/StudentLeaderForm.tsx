...
export interface StudentLeaderFormData {
  name: string;
  title: string;
  image: string;
}

export interface StudentLeaderFormProps {
...
const StudentLeaderForm: React.FC<StudentLeaderFormProps> = ({
  ...
  const [formData, setFormData] = React.useState<StudentLeaderFormData>(initialData);
    ...
    <form onSubmit={handleSubmit} className="p-6 space-y-4">
      ...
      <div>
        ...
        <input
          ...
          onChange={handleInputChange}
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          placeholder="e.g. Head Prefect, Class Monitor"
          required
          disabled={isLoading}
        />
      </div>
