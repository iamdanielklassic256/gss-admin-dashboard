...
export const ChristianNavigation = () => {
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <div className="bg-primary p-2 rounded-lg shadow-elegant relative">
              <Heart className="h-8 w-8 text-primary-foreground" />
              <Cross className="h-4 w-4 text-accent absolute -top-1 -right-1" />
            </div>
            <div className="hidden sm:block">
              <h1 className="text-xl font-bold text-primary">Hope of Glory</h1>
              <p className="text-sm text-muted-foreground">Christian School</p>
            </div>
          </div>
