...
export interface CoCurricularFormProps {
...
const CoCurricularForm: React.FC<CoCurricularFormProps> = ({
  ...
  const [formData, setFormData] = React.useState<CoCurricularFormData>(initialData);
    ...
    <form onSubmit={handleSubmit} className="p-6 space-y-4">
      ...
      <div className="flex justify-end space-x-3 pt-4">
        ...
        >
          ...
          {isLoading ? 'Saving...' : isEditing ? 'Update Activity' : 'Add Activity'}
        </button>
      </div>
    </form>
  );
