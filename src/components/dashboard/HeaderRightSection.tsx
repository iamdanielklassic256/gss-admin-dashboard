import { Bell, User, Sun, Moon, Settings, LogOut, HelpCircle, Sparkles, ChevronDown, Calendar, Mail, Activity, } from "lucide-react"
			...
			<div className="hidden lg:flex items-center gap-4 px-4 py-2 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl border border-emerald-100">
				...
				<div className="flex items-center gap-2">
					...
					<div>
						...
						<p className="text-sm font-bold text-gray-800">{getCurrentDate()}</p>
					</div>
				</div>
			</div>
